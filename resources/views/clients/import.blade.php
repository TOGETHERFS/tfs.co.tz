...
@section('title', __('messages.import_borrowers'))
@section('page-title', __('messages.import_borrowers'))

@section('content')
<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-semibold text-gray-900">{{ __('messages.import_borrowers') }}</h1>
        <p class="mt-1 text-sm text-gray-500">{{ __('messages.import_borrowers_desc') }}</p>
    </div>
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <div class="p-6">
            <form action="{{ route('clients.import.process') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-md p-4">
                    ...
                    <ul class="mt-2 text-sm text-gray-600 list-disc pl-5">
                        <li><strong>first_name</strong>, <strong>last_name</strong> - {{ __('messages.borrower_name_required') }}</li>
                        <li><strong>phone</strong> - {{ __('messages.phone_required_unique') }}</li>
                        <li><strong>email</strong> - {{ __('messages.email_optional') }}</li>
                        <li><strong>id_number</strong> - {{ __('messages.id_number_required_unique') }}</li>
                        <li><strong>date_of_birth</strong> - {{ __('messages.excel_serial_or_date') }}</li>
                        <li><strong>gender</strong> - male, female, or other</li>
                        <li><strong>address</strong>, <strong>region</strong>, <strong>district</strong>, <strong>ward</strong>, <strong>street</strong> - {{ __('messages.location_fields') }}</li>
                        <li><strong>status</strong> - {{ __('messages.borrower_status_options') }}</li>
                        <li><strong>branch_name</strong>, <strong>loan_officer</strong> - {{ __('messages.assignment_fields_optional') }}</li>
                    </ul>
                </div>
                ...
                <div class="flex items-center space-x-4 mt-6 pt-4 border-t border-gray-200">
                    ...
                    <a href="{{ route('clients.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        {{ __('messages.back_to_borrowers') }}
                    </a>
                </div>
            </form>
        </div>
