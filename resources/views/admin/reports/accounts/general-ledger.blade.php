...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Complete record of all financial transactions</p>
        </div>
        <a href="{{ route('admin.reports.accounts.index') }}" class="text-gray-600 hover:text-gray-900">Back to Accounts</a>
    </div>

    <div class="bg-white shadow rounded-lg p-6">
        <p class="text-gray-500 text-center py-8">General Ledger report coming soon.</p>
    </div>
</div>
@endsection
