...
<div class="max-w-4xl mx-auto space-y-6">
  <div class="flex items-center justify-between">
    <div>
      ...
      <p class="text-sm text-gray-600">Add a new administrative staff member with role and permissions</p>
    </div>
    ...
    <div class="bg-white border rounded-lg p-6 space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="text" name="position" id="position" value="{{ old('position') }}" placeholder="e.g., Senior Accountant"
            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
...
<script>
  ...
  // Show permissions if role is pre-selected (e.g., from old input)
