...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create SMS Package</h1>
            <p class="mt-1 text-sm text-gray-500">Add a new SMS package for tenants</p>
        </div>
        <a href="{{ route('admin.sms.packages.index') }}" class="text-gray-600 hover:text-gray-900">Back to Packages</a>
    </div>

    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" action="{{ route('admin.sms.packages.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="sms_count" value="{{ old('sms_count', 100) }}" min="1" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="number" name="price" value="{{ old('price', 4000) }}" min="0" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="currency" value="{{ old('currency', 'TZS') }}" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Create Package</button>
            </div>
        </form>
    </div>
</div>
