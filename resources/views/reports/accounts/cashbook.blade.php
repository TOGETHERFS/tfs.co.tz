...
<div class="space-y-6 max-w-5xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Cash receipts and payments register</p>
        </div>
        <div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
        <p class="text-gray-600">This is a placeholder for the Cashbook report. Filters and export options can be added here.</p>
    </div>
</div>
@endsection